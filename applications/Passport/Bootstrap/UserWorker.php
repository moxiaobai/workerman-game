...
class UserWorker extends Man\Core\SocketWorker
{
    /**
     * 与gateway的连接
        ...
        try{
            switch($cmd)
            {
                case GatewayProtocol::CMD_ON_GATEWAY_CONNECTION:
                    User::onGatewayConnect(Context::$client_id);
                    break;
                case GatewayProtocol::CMD_ON_MESSAGE:
                    User::onMessage(Context::$client_id, $pack->body);
                    break;
                case GatewayProtocol::CMD_ON_CLOSE:
                    User::onClose(Context::$client_id);
                    break;
            }
